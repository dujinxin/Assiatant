...
class TBCalendarDateCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        if(self.dateLableHeight > 0)
        {
            ...
            self.dotView.center.x = self.dateLabel.bounds.width * 0.5;
            self.dotView.center.y = self.dateLabel.bounds.height * 0.5 + 10;
    ...
    func updateCellSelectBackgroundColor() {
        ...
        self.dateLabel.backgroundColor = self.isSelected ? UIColor.rgbColor(from: 68, 32, 143) : UIColor.UIColorFromRGB(rgb: 0xffffff);
    }
