    ...
    override func layoutSubviews() {
        ...
        if self.style.isNeedCustomHeihgt! {
            ...
            case .centerDate:
                ...
                self.nextButton.frame = CGRect.init(x: selfWidth * 0.5 + 10 + 34, y: (self.dateLable.bounds.size.height - (image?.size.height)! - 20)*0.5 - 7, width: (image?.size.width)! + 20, height: (image?.size.height)! + 20);
                break;
            }
